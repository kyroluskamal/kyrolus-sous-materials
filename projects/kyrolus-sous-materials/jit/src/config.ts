...
function buildSpacing(): Record<string, string> {
...
export function mergeTheme(base: Theme, overrides?: Partial<Theme>): Theme {
  ...
  return {
    ...
    borderWidth: { ...base.borderWidth, ...(overrides.borderWidth ?? {}) },
    ...
    containerBreakpoints: { ...base.containerBreakpoints, ...(overrides.containerBreakpoints ?? {}) },
    transitionDuration: { ...base.transitionDuration, ...(overrides.transitionDuration ?? {}) },
    transitionTiming: { ...base.transitionTiming, ...(overrides.transitionTiming ?? {}) },
